class TestConfig:
    def __init__(self):
        # Feature flags 
        self.enable_json_tests = False  # Toggle JSON test generation/validation
        self.enable_validation = True  # Toggle validation for all tests
        
        # Update test case schema to include 'customer, agent'
        self.test_case_schema = {
            ...
            "properties": {
                ...
                "test_case": {"type": "string", "enum": ["json", "conversation", "customer, agent"]}
            },
        ...
        if self.enable_json_tests:
            ...
            self.metrics['json_tests'] = ['schema_compliance_rate', 'field_accuracy', 'structural_consistency']